...
# ============================================================================
# test_stage6.sh — Integration tests for Stage 6 Enforcement Gates
# ============================================================================
#
# Covers:
...
STAGE6_SCRIPT="$SCRIPT_DIR/stage6-gates.sh"
...
echo ""
echo "============================================"
echo "Stage 6 Integration Tests: $TESTS_RUN run, $TESTS_PASSED passed, $TESTS_FAILED failed"
echo "============================================"
